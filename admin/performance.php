		...
		<table id="employee_grid" class="table table-bordered table-hover" width="60%" cellspacing="0" data-toggle="bootgrid">
			...
			<thead>
				<tr>
					...
					<th data-column-id="employee_name">Employee Name</th>
					<th data-column-id="manager_name">Manager Name</th>
				  <th data-column-id="month_name">Month Name</th>
          <th data-column-id="message"> Results </th>
...
<div id="add_model" class="modal fade">
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
                   <div  id="dvPreview">
                    <img style="width:200px;height:250px;" class="img img-thumbnail" src="uploads/user.png"><br>
                  </div>
...
$( document ).ready(function() {
	...
	var grid = $("#employee_grid").bootgrid({
		...
		url: "php/performance/performance.php",
		formatters: {
...
console.log(g_id);
		...
		$('#edit_model').modal('show');
          ...
          $("#user_edit").load("php/user/user_edit.php?id="+idd);       
    ...
    }).end().find(".command-delete").on("click", function(e)
    {
		...
		var conf = confirm('Delete ' + $(this).data("row-id") + ' items?');
					//alert(conf);
                    if(conf){
                                $.post('php/performance/performance.php', { id: $(this).data("row-id"), action:'delete'}
                                    , function(){
