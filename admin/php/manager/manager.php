...
<?php
  ...
  $sql="INSERT INTO `user` (`ID`,`name`,`user_name`, `mobile`, `email`, `password`,`address`,`gender`,`dept_id`,`type`) VALUES (NULL,'$name','$user_name', '$mobile', '$email', '$password','$address','$gender','$dept_id','manager');";
...
if($result){
	...
	function getRecords($params) {
	   ...
	   // getting total number records without any search
		$sql = "SELECT *,(select name from department where ID=user.dept_id) as dept_name,(select location from department where ID=user.dept_id) as location FROM `user` ";
		$sqlTot .= $sql;
		$sqlRec .= $sql;
