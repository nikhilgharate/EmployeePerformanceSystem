...
$result=mysqli_query($conn,"select * from user where type='manager'");
while($rows1=mysqli_fetch_assoc($result)){ ?>

                      <option value="<?php echo $rows1['ID']; ?>" <?php if($rows['manager_id']==$rows1['ID']){echo "selected";} ?>><?php echo $rows1['name']; ?></option>
