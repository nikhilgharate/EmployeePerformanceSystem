...
<?php
 ...
 $dept_id = $manager['dept_id'];
  ...
  $sql="INSERT INTO `user` (`ID`,`name`,`user_name`, `mobile`, `email`, `password`,`address`,`gender`,`manager_id`,`city`,`dept_id`,`post`) VALUES (NULL,'$name','$user_name', '$mobile', '$email', '$password','$address','$gender','$manager_id','$city','$dept_id','$post');";
...
function updateEmployee($params) {
  ...
  $result = mysqli_query($this->conn,"select dept_id from user where ID='" . $params["manager_id"]."'");
