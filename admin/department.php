		...
		<table id="employee_grid" class="table table-bordered table-hover" width="60%" cellspacing="0" data-toggle="bootgrid">
			...
			<thead>
				<tr>
					...
					<th data-column-id="name">Department Name</th>
...
$( document ).ready(function() {
    ...
    $("#frm_add").on('submit',(function(e) {
        ...
        e.preventDefault();
        $.ajax({
            url: "php/department/department.php",
            type: "POST",
...
console.log(g_id);
  ...
  $("#user_edit").load("php/department/department_edit.php?id="+idd);       
    ...
    }).end().find(".command-delete").on("click", function(e)
    {
		...
		var conf = confirm('Delete ' + $(this).data("row-id") + ' items?');
					//alert(conf);
                    if(conf){
                                $.post('php/department/department.php', { id: $(this).data("row-id"), action:'delete'}
                                    , function(){
